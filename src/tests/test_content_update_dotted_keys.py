...
class TestContentUpdateWithDottedKeys(unittest.TestCase):
    ...
    def test_update_with_root_fields(self, mock_sanitize_html,
    ...
    @patch('src.content.services.ContentService.validate_slide_html_content')
    @patch('src.content.services.ContentService.sanitize_slide_html_content')
    def test_update_with_nested_content_dict(self, mock_sanitize_html,
                                            mock_validate_html, mock_get_content_type, mock_get_db):
        """
    ...
    @patch('src.content.services.ContentService.validate_slide_html_content')
    @patch('src.content.services.ContentService.sanitize_slide_html_content')
    def test_update_with_dotted_keys_only(self, mock_sanitize_html,
                                        mock_validate_html, mock_get_content_type, mock_get_db):
        """
    ...
    # test_update_template_validation_failure removed - template_snapshot validation no longer exists
