...
def create_period():
    ...
    try:
        ...
        if success:
            return APIRoute.success({"id": result}, message="Período académico creado exitosamente", status_code=201)
        else:
...
def get_level_periods(level_id):
    ...
    try:
        ...
        return APIRoute.success(periods)
    except Exception as e:
        return APIRoute.error(ErrorCodes.SERVER_ERROR, str(e), status_code=500)
...
def get_period(period_id):
    ...
    try:
        ...
        if period:
            return APIRoute.success(period)
        else:
...
def create_section():
    ...
    try:
        ...
        if success:
            return APIRoute.success({"id": result}, message="Sección creada exitosamente", status_code=201)
        else:
            return APIRoute.error(ErrorCodes.CREATION_ERROR, result)
    except Exception as e:
        return APIRoute.error(ErrorCodes.SERVER_ERROR, str(e), status_code=500)
...
def get_level_sections(level_id):
    ...
    try:
        ...
        return APIRoute.success(sections)
    except Exception as e:
        return APIRoute.error(ErrorCodes.SERVER_ERROR, str(e), status_code=500)
...
def get_section(section_id):
    ...
    try:
        ...
        if section:
            return APIRoute.success(section)
        else:
...
def create_subject():
    ...
    try:
        ...
        if success:
            return APIRoute.success({"id": result}, message="Materia creada exitosamente", status_code=201)
        else:
            return APIRoute.error(ErrorCodes.CREATION_ERROR, result)
    except Exception as e:
        return APIRoute.error(ErrorCodes.SERVER_ERROR, str(e), status_code=500)
...
def get_level_subjects(level_id):
    ...
    try:
        ...
        return APIRoute.success(subjects)
    except Exception as e:
        return APIRoute.error(ErrorCodes.SERVER_ERROR, str(e), status_code=500)
...
def get_subject_details(subject_id):
    ...
    try:
        ...
        if subject:
            return APIRoute.success(subject)
        else:
