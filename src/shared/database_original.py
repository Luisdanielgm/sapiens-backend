...
def setup_database_indexes():
    ...
    with DatabaseConnection._indexes_setup_lock:
        ...
        try:
            ...
            # Índice único para quiz: (topic_id, content_type)
            _ensure_index(
                content_coll,
                [("topic_id", ASCENDING), ("content_type", ASCENDING)],
                name="idx_unique_topic_content_type_quiz",
                background=True,
                unique=True,
        ...
        # Marcar que los índices han sido configurados exitosamente
