    ...
    def _get_base_model_prices(self) -> Dict:
        ...
        return {
            "gemini": {
                ...
                "gemini-3-pro-preview": {"input": 0.002, "output": 0.01},
            ...
            "openrouter": {
                ...
                "x-ai/grok-4.1-fast": {"input": 0.0015, "output": 0.006},
                "x-ai/grok-4.1-fast:free": {"input": 0.001, "output": 0.004},
                "anthropic/claude-haiku-4.5": {"input": 0.0008, "output": 0.004},
                "minimax/minimax-m2": {"input": 0.0015, "output": 0.006},
                "moonshotai/kimi-k2-thinking": {"input": 0.0015, "output": 0.006},
                "moonshotai/kimi-linear-48b-a3b-instruct": {"input": 0.0015, "output": 0.006},
                "kwaipilot/kat-coder-pro:free": {"input": 0.001, "output": 0.004},
                "openai/gpt-5.1-codex-mini": {"input": 0.002, "output": 0.01},
                "openai/gpt-5.1-codex": {"input": 0.003, "output": 0.012},
                "openai/gpt-5.1": {"input": 0.0035, "output": 0.014},
                "google/gemini-3-pro-preview": {"input": 0.002, "output": 0.01},
            },
            "requesty": {
                ...
                "moonshot/kimi-k2-0711-preview": {"input": 0.0015, "output": 0.006},
                "anthropic/claude-haiku-4-5-20251001": {"input": 0.0008, "output": 0.004},
                "anthropic/claude-sonnet-4-5-20250929": {"input": 0.0025, "output": 0.012},
                "anthropic/claude-sonnet-4": {"input": 0.003, "output": 0.015},
                "alibaba/qwen3-coder-plus": {"input": 0.0015, "output": 0.006},
                "groq/openai/gpt-oss-20b": {"input": 0.0011, "output": 0.0044},
                "groq/moonshotai/Kimi-K2-Instruct-0905": {"input": 0.0015, "output": 0.006},
                "groq/moonshotai/kimi-k2-instruct": {"input": 0.0015, "output": 0.006},
                "groq/openai/gpt-oss-120b": {"input": 0.0011, "output": 0.0044},
                "mistral/codestral-latest": {"input": 0.0015, "output": 0.006},
                "nebius/zai-org/GLM-4.5": {"input": 0.0011, "output": 0.0044},
                "nebius/moonshotai/Kimi-K2-Instruct": {"input": 0.0015, "output": 0.006},
            },
            "claude": {
                # Claude 3.5 family
